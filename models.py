...
class User(UserMixin, db.Model):
    ...
    def set_password(self, password):
        # Force pbkdf2:sha256 for compatibility with Python 3.13.1 + Werkzeug 3.0.4
    ...
    def check_password(self, password):
        try:
            ...
            # If there's a compatibility issue with existing hash, log and fail gracefully
            print(f"Password hash compatibility issue: {e}")
            return False
